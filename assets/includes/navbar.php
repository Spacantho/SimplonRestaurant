<header>
    <div id="hamburger">
        <img id="logo" src="assets/images/LogoSimplonResto.png" alt="LogoSimplonResto">
            ...
            <div id="hamburger-sidebar">
                <div id="hamburger-sidebar-header"><img id="logo-sidebar" src="assets/images/LogoSimplonResto.png" alt="LogoSimplonResto"></div>
